...
function game_addFront(){
    wp_enqueue_style('ctWA-tarot-css', trailingslashit(GAME_PLUD_DIR).'assets/css/game-front-style.css' , false, '1.0', 'all');
    wp_enqueue_script('ctWA-tarot-front-js', trailingslashit(GAME_PLUD_DIR).'assets/js/game-front-js.js',
    []
    , true);
}